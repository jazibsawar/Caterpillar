...
export const deployRuntimeRegistryHandler = (registryService, response: Response) => {
  try {
...
export const getRuntimeRegistryInfoHandler = (registryService, request: Request, response: Response) => {
  printl(10, [
